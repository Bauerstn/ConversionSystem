...
namespace ConversionSystem.Common.Entity.Repositories
{
    /// <summary>
    ...
    public static class CommonSpecs
    {
        ...
        /// </summary>
        public static Task<IReadOnlyCollection<TEntity>> ToReadOnlyCollectionAsync<TEntity>(this IQueryable<TEntity> query, CancellationToken cancellationToken)
