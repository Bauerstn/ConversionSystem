...
{
    /// <summary>
    /// Валидатор класса <see cref="CreateProductPresentationRequest"/>
    /// </summary>
    public class CreateProductPresentationRequestValidator : AbstractValidator<CreateProductPresentationRequest>
    {
        /// <summary>
        /// Инициализирует <see cref="CreateProductPresentationRequestValidator"/>
        /// </summary>
